				...
				<div class="section m-0 clearfix" style="background-color: #eef2f5;">
					<div class="container clearfix">
						...
						<div class="heading-block center border-bottom-0 bottommargin topmargin-sm mx-auto" style="max-width: 640px">
							<h3 class="nott font-secondary font-weight-normal" style="font-size: 36px;">Cat Toolkit</h3>
							<span>Kami menawarkan beberapa toolkit untuk kucing kesayangan anda</span>
						</div>
						...
						<div class="row clearfix">
							...
							<div class="row clearfix">
								<?php
									if(empty($toolkit)) {
										echo "<h2>Belum Ada Data Toolkit</h2>";
									} else {
								?>
								
								<?php foreach ($toolkit as $s) : ?>
									<form action="<?= base_url('MidtransController') ?>" method="post" >
											<input type="hidden" name="jenis" value="toolkit"/>
											<input type="hidden" name="id_m" value="<?= $s->id_toolkit ?>"/>
											<input type="hidden" name="nama" value="<?= $s->nama_toolkit ?>"/>
